...
App.accessRule('https://*.craigslist.org/', { type: 'intent' });
App.accessRule('http://*.craigslist.org/', { type: 'intent' });

// Set up resources such as icons and launch screens.
App.icons({
  'iphone_2x': 'public/images/apple-touch-icon-120x120.png',
  'iphone_3x': 'public/images/apple-touch-icon-180x180.png',
  // 'ipad': 'public/images/apple-touch-icon-',
  'ipad_2x': 'public/images/apple-touch-icon-152x152.png',
  // 'ipad_pro': 'public/images/apple-touch-icon-',
  // 'ios_settings': 'public/images/apple-touch-icon-',
  'ios_settings_2x': 'public/images/apple-touch-icon-57x57.png',
  // 'ios_settings_3x': 'public/images/apple-touch-icon-',
  // 'ios_spotlight': 'public/images/apple-touch-icon-',
  // 'ios_spotlight_2x': 'public/images/apple-touch-icon-',
  'android_mdpi': 'public/images/apple-touch-icon-57x57.png',
  'android_hdpi': 'public/images/apple-touch-icon-72x72.png',
  'android_xhdpi': 'public/images/apple-touch-icon-76x76.png',
  'android_xxhdpi': 'public/images/apple-touch-icon-144x144.png',
  'android_xxxhdpi': 'public/images/apple-touch-icon-180x180.png'
