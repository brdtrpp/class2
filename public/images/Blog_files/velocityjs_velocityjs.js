...
///////////////////////////////////////////////////////////////////////
//                                                                   //
// packages/velocityjs_velocityjs/packages/velocityjs_velocityjs.js  //
//                                                                   //
///////////////////////////////////////////////////////////////////////
                                                                     //
(function () {                                                       // 1
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                   //
// packages/velocityjs:velocityjs/velocity.min.js                                                                    //
//                                                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                   //
// packages/velocityjs:velocityjs/velocity.ui.js                                                                     //
//                                                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                     //
/**********************                                                                                              // 1
            ...
            $.each(sequence.reverse(), function(i, currentCall) {                                                    // 725
                ...
                if (nextCall) {                                                                                      // 728
                    ...
                    var timing = (currentCall.options && currentCall.options.sequenceQueue === false) ? "begin" : "complete",
                        callbackOriginal = nextCall.options && nextCall.options[timing],                             // 733
                        options = {};                                                                                // 734
                                                                                                                     // 735
                    options[timing] = function() {                                                                   // 736
                        var nextCallElements = nextCall.elements || nextCall.e;                                      // 737
                        var elements = nextCallElements.nodeType ? [ nextCallElements ] : nextCallElements;          // 738
                                                                                                                     // 739
                        callbackOriginal && callbackOriginal.call(elements, elements);                               // 740
                        Velocity(currentCall);                                                                       // 741
                    }                                                                                                // 742
                                                                                                                     // 743
                    nextCall.options = $.extend({}, nextCall.options, options);                                      // 744
                }                                                                                                    // 745
            });                                                                                                      // 746
                                                                                                                     // 747
            sequence.reverse();                                                                                      // 748
        }                                                                                                            // 749
                                                                                                                     // 750
        Velocity(sequence[0]);                                                                                       // 751
    };                                                                                                               // 752
}((window.jQuery || window.Zepto || window), window, document);                                                      // 753
}));                                                                                                                 // 754
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                     // 785
}).call(this);                                                       // 786
